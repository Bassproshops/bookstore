...
const ProductsListComponent = ({ search, }) => {
    ...
    useEffect(() => {
        if (search) {
            axios.listProducts(SetProducts, page, maxPrice, minPrice, search, ordering, promotionFilter);
        }
    }, [page, search, router.asPath])
    ...
    function handlePriceChange(e) {
        ...
        axios.listProducts(SetProducts, 1, maxPrice, minPrice, search, ordering, promotionFilter, false);
    ...
    function handlePriceFilterDelete(e) {
        ...
        SetMinPrice('');
        SetMaxPrice('');
        axios.listProducts(SetProducts, 1, '', '', search, ordering, promotionFilter, false);
    ...
    function changeInOrder(e) {
        ...
        SetDisplayFilters(false);
        axios.listProducts(SetProducts, 1, maxPrice, minPrice, search, e.target.value, promotionFilter, false);
    }
        ...
        <div className="container separate product-cont">
            ...
            <div className="products-list-container">
                ...
                <div className={displayFilters ? "filters display-filters" : "filters"}>
                    ...
                    {
                        search && <h2 className="search-result-filters">Resultados de "{search}"</h2>
                    }
